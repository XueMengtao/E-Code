...
namespace FileObject
{
    public class TxObject
    {
        ...
        public static TxObject test = null;

        private TxObject(string str)
        {
            int start;
            int linelength;
            linelength = Tool.readline(str, 1);
            name = str.Substring(1, linelength);
            start = str.IndexOf("TxSet");
            ...
            start = str.IndexOf("pattern_show_arrow");
            //linelength = Tool.readline(str, start);
        ...
        public static TxObject txObjFac(string str)
        {

            TxObject txobj = new TxObject(str);
            test = txobj;
            return test;
        }
    }
